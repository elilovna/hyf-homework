(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('http'), require('events'), require('path'), require('util'), require('tty'), require('fs'), require('net'), require('buffer'), require('string_decoder'), require('stream'), require('zlib'), require('querystring'), require('url'), require('crypto')) :
  typeof define === 'function' && define.amd ? define(['http', 'events', 'path', 'util', 'tty', 'fs', 'net', 'buffer', 'string_decoder', 'stream', 'zlib', 'querystring', 'url', 'crypto'], factory) :
  (global = global || self, factory(global.http, global.events, global.path, global.util, global.tty, global.fs, global.net, global.buffer, global.string_decoder, global.stream, global.zlib, global.querystring, global.url, global.crypto));
}(this, function (http, events, path, util, tty, fs, net, buffer, string_decoder, stream, zlib, querystring, url, crypto) { 'use strict';
  ...
  app.use(express$1.static(__dirname + '/public'));
